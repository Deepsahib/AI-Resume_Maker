...
const Testimonial = () => {
  ...
  return (
    ...
    <span>Testimonials</span>
      ...
      <Title title={"Don't just take our words" } description={'Hear what our users say about us! We’re always looking for ways to improve. If you’ve had a positive experience with us, leave a review.'} />
    </div>
      <style>{`
