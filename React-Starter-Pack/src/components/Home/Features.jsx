...
const Features = () => {
  ...
  return (
            <div id='features' className='flex flex-col items-center my-10 scroll-mt-10'>
                <div class="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 py-1.5 rounded-full px-6">
        <Zap />
    <span>Simple Process</span>
</div>

      <Title title={'Build your resume faster'} description={'Create professional resumes in minutes with AI-powered enhancement, live preview, and instant PDF generation'} />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Smart suggestions to improve your resume content and make it more professional.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Live Preview & Edit</h3>
                                <p className="text-sm text-slate-600 max-w-xs">See your resume changes in real-time with our split-screen editor interface.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Download your professional resume as a high-quality PDF instantly.</p>
                            </div>
                        </div>
                    </div>
                </div>
